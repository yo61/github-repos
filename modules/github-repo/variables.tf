...
variable "merge_commit_message" {
  description = "Can be PR_BODY, PR_TITLE, or BLANK for a default merge commit message. Applicable only if allow_merge_commit is true. GitHub rejects MERGE_MESSAGE+BLANK: only PR_TITLE+PR_BODY, PR_TITLE+BLANK, and MERGE_MESSAGE+PR_TITLE are valid."
  type        = string
  default     = "PR_TITLE"
  nullable    = false
  validation {
